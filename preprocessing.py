...
def nettoyer_segmenter(text: str, langue="french"):
    """
    Nettoie un texte brut (Markdown/HTML) puis le segmente en phrases et tokens.

    Args:
        text (str): texte brut d’entrée.
        langue (str): langue du texte ("french" ou "english").

    Returns:
        tuple:
            - list of str: phrases originales (non tokenisées).
            - list of list of str: phrases tokenisées et nettoyées.
    """
    ...
    for phrase in phrases:
        ...
        tokens = [
            mot for mot in tokens if mot.isalnum()
